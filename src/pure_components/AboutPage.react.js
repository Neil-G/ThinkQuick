	...
	render(){
		return(
			<div className="container" style={{ textAlign: 'center', position: 'relative' }}>
				...
				<a href="https://www.github.com/Neil-G/ThinkQuick" target="_blank">
					<svg width="25px" height="25px" viewBox="0 0 126 123" className='github-icon' style={{ position: 'fixed', top: '20px', left: '12px' }}>
					    ...
					    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					        <g id="Font-Awesome-Icon-Pack" transform="translate(-3111.000000, -913.000000)" fill="#000000">
				...
				<p className='instruction-box' style={{ background: '#CFD8DC' }}> Each with 3 Numbers and 1 operation  </p> 
				<p className='instruction-box' style={{ background: '#B0BEC5' }}> Addition or Multiplication </p> 
				<p className='instruction-box' style={{ background: '#90A4AE', color: 'rgba(255,255,255,0.87)' }}> Be the first to answer any problem successfully... </p> 
				<p className='instruction-box' style={{ background: '#78909C', color: 'rgba(255,255,255,0.87)' }}> And watch your name get sent to the Winners column </p> 
				<p className='instruction-box' style={{ background: '#607D8B', color: 'rgba(255,255,255,0.87)' }}> Each problem automatically regenerates when a correct solution is submitted </p> 
				<p className='instruction-box' style={{ background: '#546E7A', color: 'rgba(255,255,255,0.87)' }}> Not Signed Up Yet? No Problem! </p>
				<p className='instruction-box' style={{ background: '#455A64', color: 'rgba(255,255,255,0.87)' }}> Enter a Username and Password to Login... </p> 
				<p className='instruction-box' style={{ background: '#37474F', color: 'rgba(255,255,255,0.87)' }}> And if the account doesnt exist, it will be created and signed in automatically </p> 
				<p className='instruction-box' style={{ background: '#263238', color: 'rgba(255,255,255,0.87)' }}> Oh, and this is real-time so you're competing against anyone else playing, and you're all seeing the same screen and getting updates as soon as they happen! </p> 
				{/* PLAY BUTTON */}
