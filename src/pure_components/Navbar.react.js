...
export class NavBar extends Component {
	...
	render(){
		...
		return(
			<nav className='nav-header' style={{ background: headerColor, transition: '2s all' }}>
      		...
      		userIsLoggedIn ? 
      			...
      			<div> 
		      		...
		      		<div style={{ border: '0px solid tomato', padding: '8px 0 0 6px', color: '#ECEFF1', height: '100%'  }}>
			      		<Link to="/" style={{ color: headerText, display: 'inline-block', transition: '2s all' }}> 
			      			<h3 style={{ margin: '0'}}>
				      			ThinkQuick, <br/> 
      		...
      		<div>
	      		...
	      		<LoginForm firebaseRef={firebaseRef} headerText={headerText} />
	      			...
	      			<div style={{ border: '0px solid tomato', padding: '8px 0 0 6px', height: '100%', maxWidth: '300px' }}>
			      	 	<Link to="/" style={{ color: headerText, transition: '2s all' }} className="hide-small"> 
